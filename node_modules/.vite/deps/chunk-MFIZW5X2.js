...
var require_duration = __commonJS({
  "node_modules/dayjs/plugin/duration.js"(exports, module) {
    !function(t, s) {
      ...
      "use strict";
      var t, s, n = 1e3, i = 6e4, e = 36e5, r = 864e5, o3 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, u = 31536e6, d = 2628e6, a = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/, h = { years: u, months: d, days: r, hours: e, minutes: i, seconds: n, milliseconds: 1, weeks: 6048e5 }, c = function(t2) {
        return t2 instanceof g;
      }, f2 = function(t2, s2, n2) {
        ...
        function l2(t2, s2, n2) {
          var i2 = this;
          if (this.$d = {}, this.$l = n2, void 0 === t2 && (this.$ms = 0, this.parseFromMilliseconds()), s2) return f2(t2 * h[m(s2)], this);
        ...
        return y2.calMilliseconds = function() {
          ...
          var i2 = v(n2, "D"), e2 = v(this.$d.hours, "H"), r2 = v(this.$d.minutes, "M"), o4 = this.$d.seconds || 0;
          this.$d.milliseconds && (o4 += this.$d.milliseconds / 1e3, o4 = Math.round(1e3 * o4) / 1e3);
          var u2 = v(o4, "S"), d2 = t2.negative || s2.negative || i2.negative || e2.negative || r2.negative || u2.negative, a2 = e2.format || r2.format || u2.format ? "T" : "", h2 = (d2 ? "-" : "") + "P" + t2.format + s2.format + i2.format + a2 + e2.format + r2.format + u2.format;
          return "P" === h2 || "-P" === h2 ? "P0D" : h2;
        }, y2.toJSON = function() {
          return this.toISOString();
        }, y2.format = function(t2) {
          var n2 = t2 || "YYYY-MM-DDTHH:mm:ss", i2 = { Y: this.$d.years, YY: s.s(this.$d.years, 2, "0"), YYYY: s.s(this.$d.years, 4, "0"), M: this.$d.months, MM: s.s(this.$d.months, 2, "0"), D: this.$d.days, DD: s.s(this.$d.days, 2, "0"), H: this.$d.hours, HH: s.s(this.$d.hours, 2, "0"), m: this.$d.minutes, mm: s.s(this.$d.minutes, 2, "0"), s: this.$d.seconds, ss: s.s(this.$d.seconds, 2, "0"), SSS: s.s(this.$d.milliseconds, 3, "0") };
          return n2.replace(o3, function(t3, s2) {
          ...
          var i2;
          return i2 = s2 ? t2 * h[m(s2)] : c(t2) ? t2.$ms : f2(t2, this).$ms, f2(this.$ms + i2 * (n2 ? -1 : 1), this);
    ...
    !function(e, t) {
      ...
      return function(t, i, s) {
        ...
        d.isoWeekYear = function() {
          ...
          var i2, d2, n2, o3, r = a(this), u = (i2 = this.isoWeekYear(), d2 = this.$u, n2 = (d2 ? s.utc : s)().year(i2).startOf("year"), o3 = 4 - n2.isoWeekday(), n2.isoWeekday() > 4 && (o3 += 7), n2.add(o3, e));
    ...
    (function(globalThis2) {
      var irrelevant = function(exports2) {
        ...
        function readBlobAsText(blob) {
          var reader = new FileReader();
          var promise = fileReaderReady(reader);
          var match3 = /charset=([A-Za-z0-9_-]+)/.exec(blob.type);
          var encoding = match3 ? match3[1] : "utf-8";
        ...
        function fetch2(input, init2) {
          return new Promise(function(resolve, reject3) {
            ...
            xhr.ontimeout = function() {
              setTimeout(function() {
                reject3(new TypeError("Network request timed out"));
              }, 0);
            };
...
var isPredefinedGranularity = (granularity) => !!TIME_SERIES[granularity];
...
var timeSeriesFromCustomInterval = (from, to, granularity) => {
...
var diffTimeUnitForInterval = (interval) => {
...
var minGranularityForIntervals = (i1, i2) => {
...
//# sourceMappingURL=chunk-MFIZW5X2.js.map
